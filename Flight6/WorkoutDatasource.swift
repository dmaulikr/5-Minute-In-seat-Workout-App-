...
class WorkoutDataSource{
    ...
    init() {
        ...
        let rest4 = Workout(title: "Rest", workoutText: "Take deep breaths and calm your nerves.", color:  color:  UIColor(hue: 0.7861, saturation: 0.6, brightness: 0.33, alpha: 1.0) /* #472255 */)
